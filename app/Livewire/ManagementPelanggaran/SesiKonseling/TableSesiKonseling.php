...
class TableSesiKonseling extends Component
{
    ...
    {
         $dataKonseling = CounselingSession::select(
            'students.name',
        ...
        ->join('violation_reports', 'counseling_sessions.violation_report_id', '=', 'violation_reports.id')->paginate(10);

        return view('livewire.management-pelanggaran.sesi-konseling.table-sesi-konseling', ['dataKonseling' => $dataKonseling]);
    }
}
