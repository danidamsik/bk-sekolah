    ...
    <div x-show="$wire.isOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="p-6 space-y-5">
            ...
            <div x-data="{ showOldPw: false }">
                ...
                <div class="relative">
                    <input :type="showOldPw ? 'text' : 'password'" wire:model="old_pw"
            ...
            <div x-data="{ showNewPw: false }">
                ...
                <div class="relative">
                    <input :type="showNewPw ? 'text' : 'password'" wire:model="new_pw"
            ...
            <div x-data="{ showConfirPw: false }">
                ...
                <div class="relative">
                    <input :type="showConfirPw ? 'text' : 'password'" wire:model="confir_pw"
        ...
        <div class="px-6 py-4 bg-gray-50 rounded-b-xl flex justify-end space-x-3">
            <button @click="$wire.isOpen = false;" wire:loading.attr="disabled"
