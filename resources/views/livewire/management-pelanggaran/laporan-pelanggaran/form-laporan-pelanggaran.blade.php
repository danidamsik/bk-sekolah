    ...
    <form action="#" method="POST" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input x-model="laporanPelanggaran.nama_siswa" type="text" name="nama_siswa"
            ...
            <div>
                ...
                <input x-model="laporanPelanggaran.class_name" type="text" name="kelas"
                    class="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-400 outline-none transition-all duration-200"
            ...
            <div>
                ...
                <input x-model="laporanPelanggaran.name_pelanggaran" type="text" name="jenis_pelanggaran"
                    class="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-400 outline-none transition-all duration-200"
            ...
            <div>
                ...
                <input x-model="laporanPelanggaran.name_teacher" type="text" name="guru_pelapor"
                    class="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-400 outline-none transition-all duration-200"
            ...
            <div>
                ...
                <input x-model="laporanPelanggaran.date" type="date" name="tanggal"
                    class="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-400 outline-none transition-all duration-200">
            </div>

            <div>
                <label class="block text-sm font-semibold text-gray-600 mb-1">Status</label>
                <select x-model="laporanPelanggaran.status"
                    name="status"
                    class="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-400 outline-none transition-all duration-200">
