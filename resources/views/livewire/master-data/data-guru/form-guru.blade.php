<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 space-y-4 animate-slideUp">
    ...
    <form id="formGuru" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label class="text-sm text-gray-600">Nama Guru</label>
            <input type="text" id="namaGuru" placeholder="Masukkan nama guru"
        ...
        <div>
            ...
            <input type="text" id="nipGuru" placeholder="Masukkan NIP"
                class="w-full border border-gray-300 rounded-lg p-2 mt-1 focus:ring-2 focus:ring-blue-400 outline-none">
        </div>
        <div>
            <label class="text-sm text-gray-600">Email</label>
            <input type="email" id="emailGuru" placeholder="Masukkan email guru"
                class="w-full border border-gray-300 rounded-lg p-2 mt-1 focus:ring-2 focus:ring-blue-400 outline-none">
        </div>
        <div>
            <label class="text-sm text-gray-600">No HP</label>
            <input type="text" id="noHpGuru" placeholder="Masukkan nomor HP"
                class="w-full border border-gray-300 rounded-lg p-2 mt-1 focus:ring-2 focus:ring-blue-400 outline-none">
        </div>
    </form>
    <div class="flex justify-end">
        <button onclick="tambahDataGuru()"
